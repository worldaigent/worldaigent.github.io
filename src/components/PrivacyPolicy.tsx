            ...
            <div className="legal-layout">
                ...
                <article className="legal-body">
                    ...
                    <section id="gdpr">
                        ...
                        <p>Clients acting as controllers are covered by our <a href="/dpa">Data Processing Agreement</a>, which gives effect to Article 28 GDPR and sets out the sub-processors, security measures, transfer mechanism and deletion terms that apply. A countersigned copy, or review of your own template, is available on request.</p>
